<%
' I (Adam Jarret) did not write the code on this page. This ASP 3.0 encryption library
' is available free of charge from http://www.frez.co.uk. See original software notice
' below.
'
' -------------------------------------------------------------------------------------
'
